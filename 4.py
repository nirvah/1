...
# Draw the original and transformed objects on the canvas
cv2.polylines(canvas, [obj_points], True, (0, 0, 0), 2)  # Original square in black
cv2.polylines(canvas, [translated_obj], True, (0, 255, 0), 2)  # Translated square in green
cv2.polylines(canvas, [rotated_obj], True, (0, 0, 255), 2)  # Rotated square in red
cv2.polylines(canvas, [scaled_obj], True, (255, 0, 0), 2)  # Scaled square in blue
